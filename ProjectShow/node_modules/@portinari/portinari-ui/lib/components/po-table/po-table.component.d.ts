...
export declare class PoTableComponent extends PoTableBaseComponent implements AfterViewInit, DoCheck, OnDestroy {
    ...
    readonly hasCheckboxColumn: boolean;
    readonly hasFooter: boolean;
    readonly hasMainColumns: boolean;
    ...
    readonly mainColumns: PoTableColumn[];
    ...
    getColumnTitleLabel(column: PoTableColumn): string;
    ...
    private getColumnIconsFromProperty;
