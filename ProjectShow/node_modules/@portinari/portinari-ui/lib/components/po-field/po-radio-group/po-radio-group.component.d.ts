import { DoCheck, ElementRef, IterableDiffers, QueryList } from '@angular/core';
 ...
 *
 */
export declare class PoRadioGroupComponent extends PoRadioGroupBaseComponent implements DoCheck {
    /** Label do campo. */
    label?: string;
