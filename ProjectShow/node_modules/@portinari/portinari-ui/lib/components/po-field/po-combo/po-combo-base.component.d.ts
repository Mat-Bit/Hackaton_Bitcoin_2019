...
export declare abstract class PoComboBaseComponent implements ControlValueAccessor, OnInit, Validator {
    ...
    compareMethod(search: string, option: PoComboOption, filterMode: PoComboFilterMode): boolean;
    startsWith(search: string, option: PoComboOption): boolean;
    contains(search: string, option: PoComboOption): boolean;
    endsWith(search: string, option: PoComboOption): boolean;
    getOptionFromValue(value: any, options: any): any;
    getOptionFromLabel(label: any, options: any): any;
    updateSelectedValue(option: PoComboOption, isUpdateModel?: boolean, isWriteValue?: boolean): void;
    callModelChange(value: any): any;
    isEqual(value: any, inputValue: any): boolean;
    searchForLabel(search: string, options: Array<PoComboOption>, filterMode: PoComboFilterMode): void;
    updateComboList(options?: Array<PoComboOption>): void;
    getNextOption(value: any, options: Array<PoComboOption>, reverse?: boolean): any;
