import { ChangeDetectorRef, DoCheck, ElementRef, IterableDiffers, OnDestroy, Renderer2 } from '@angular/core';
 ...
 * </example>
 */
export declare class PoComboComponent extends PoComboBaseComponent implements DoCheck, OnDestroy {
    element: ElementRef;
    ...
    onOptionClick(option: PoComboOption, event?: any): void;
